...
class FranceConferencesFirstDayViewController: UIViewController {
    ...
    let segmentedControl: UISegmentedControl = {                                        // Objeto Segmented Control
        ...
        sc.addTarget(FranceConferencesFirstDayViewController.self, action: #selector(handlesegmentChange), for: .valueChanged)  // Target (indicador) de la posicion del segmented control
        return sc
    }()
    ...
    private func showPopUpAddMiItinerario () -> UIView {
        ...
        let storyBoard: UIStoryboard = UIStoryboard(name: "AddItineraryPopUp", bundle: nil)
        let popUpSeeItinerarioVC = storyBoard.instantiateViewController(withIdentifier: "seeMiItinerario") as! popUpAddMiItinerarioViewController
        //let navBarOnModal: UINavigationController = UINavigationController(rootViewController: popUpSeeItinerarioVC)
...
// MARK: - UITableViewDelegate, UITableViewDataSource
    // Delegados de la Table View
extension FranceConferencesFirstDayViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func btnInfoAction (sender: UIButton) {
        ...
        let storyBoard: UIStoryboard = UIStoryboard(name: "detailConferencia", bundle: nil)
        let popUpVC = storyBoard.instantiateViewController(withIdentifier: "detailConferencia") as! detailConferenciaViewController
        ...
        */
        ...
        popUpVC.titleConferencia = conferenciaFamex[indexPathAux.row].title
        popUpVC.authorConferencia = conferenciaFamex[indexPathAux.row].author
        popUpVC.descriptionConferencia = conferenciaFamex[indexPathAux.row].description
        popUpVC.timeConferencia = conferenciaFamex[indexPathAux.row].publishedAt
        popUpVC.placeConferencia = conferenciaFamex[indexPathAux.row].url
